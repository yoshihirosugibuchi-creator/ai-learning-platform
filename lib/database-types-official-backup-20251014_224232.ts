  ...
  public: {
    Tables: {
      ...
      user_knowledge_collection_v2: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_knowledge_collection_v2_theme_id"
            columns: ["theme_id"]
            isOneToOne: false
...
// ============= New Knowledge Cards Type Aliases =============
export type KnowledgeCard = Database['public']['Tables']['knowledge_cards']['Row']
export type KnowledgeCardInsert = Database['public']['Tables']['knowledge_cards']['Insert']
export type KnowledgeCardUpdate = Database['public']['Tables']['knowledge_cards']['Update']
export type UserKnowledgeCollectionV2 = Database['public']['Tables']['user_knowledge_collection_v2']['Row']
export type UserKnowledgeCollectionV2Insert = Database['public']['Tables']['user_knowledge_collection_v2']['Insert']
export type UserKnowledgeCollectionV2Update = Database['public']['Tables']['user_knowledge_collection_v2']['Update']
