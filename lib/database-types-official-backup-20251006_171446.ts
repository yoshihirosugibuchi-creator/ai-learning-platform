...
export type LearningRecommendation = Database['public']['Tables']['learning_recommendations']['Row']
export type LearningRecommendationInsert = Database['public']['Tables']['learning_recommendations']['Insert']
export type LearningRecommendationUpdate = Database['public']['Tables']['learning_recommendations']['Update']
