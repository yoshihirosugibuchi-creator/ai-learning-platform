  ...
  public: {
    Tables: {
      ...
      xp_level_skp_settings: {
        Row: {
          created_at: string | null
          hint_level1_penalty_percent: number | null
          hint_level2_penalty_percent: number | null
          hint_level3_penalty_percent: number | null
          id: number
          is_active: boolean | null
...
// ============= New Type Aliases for Hint System =============
...
// ============= Daily Analytics Batch Types (Missing) =============
