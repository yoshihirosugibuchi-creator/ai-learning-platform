 ...
 * Auto-generated from database on 2025-09-24T13:24:27.060Z
...
export const categoryDisplayNames: Record<string, string> = {
  ...
  'financial_services_industry': '金融業界',
  'life_insurance_industry': '生命保険業界',
...
export const subcategoryDisplayNames: Record<string, string> = {
  ...
  'life_insurance_market': '生保市場・業界構造',
  'insurance_products_model': '保険商品体系・ビジネスモデル',
  'insurance_business_process': '保険業務プロセス',
  'insurance_asset_management': '保険資産運用・ALM',
  'insurance_information_systems': '保険情報システム',
  'insurance_dx_insurtech': '保険DX・インシュアテック',
  'insurance_regulation': '保険法規制・コンプライアンス',
  'insurance_management_strategy': '保険経営戦略・課題',
...
- Subcategories: 145
- Last updated: 2025-09-24T13:24:27.060Z
*/