...
export type Database = {
  ...
  public: {
    Tables: {
      ai_course_workflows: {
        Row: {
          ...
          outline_review_notes: string | null
      ...
      ai_manual_input_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_manual_input_history_workflow_id_fkey"
            columns: ["workflow_id"]
            isOneToOne: false
            referencedRelation: "ai_course_workflows"
          ...
          },
          {
            ...
            columns: ["workflow_id"]
            isOneToOne: false
            referencedRelation: "ai_workflow_overview"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      create_course_transaction: {
        Args: {
          publish_options: string
          publish_type: string
          workflow_data: string
        }
        Returns: string
      }
      create_test_workflow: { Args: { test_user_id: string }; Returns: string }
      ...
      migrate_existing_workflow_data: { Args: never; Returns: undefined }
      ...
      validate_course_basic_info: {
        Args: { basic_info: Json }
        Returns: boolean
      }
    }
    Enums: {
