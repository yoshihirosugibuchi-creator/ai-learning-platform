  ...
  try {
    ...
    const { data: problem, error: problemError } = await supabaseAdmin
      ...
      .insert({
        ...
        primary_subcategory_id: body.primary_subcategory_id || 'structured_thinking',
    ...
    const stepsToInsert = body.steps.map((step, index) => {
      ...
      return {
        ...
        subcategory_id: step.subcategory_id || body.primary_subcategory_id || 'structured_thinking',
